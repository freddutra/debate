...
try{
    ...
    if($countanswers <= 0){ header("Location: manage.php?id=$courseid&action=13&psid="); }
    ...
    if($countanswers != count($avaliablestudent)){ header("Location: manage.php?id=$courseid&action=12&psid="); }    
    ...
    if(is_int($newgroupscount) == true){
        ...
        header("Location: manage.php?id=$courseid&action=1&psid=");
    }
    else{
        header("Location: manage.php?id=$courseid&action=10&psid=");
    }
}
catch(\Exception $e) {
