...
try{
    ...
    try{
        ...
        $DB->insert_record('role_capabilities', array('contextid'=>$forumdata->id, 'capability'=> "mod/forum:replypost", "roleid"=>5, "permission"=>-1000, "timemodified"=>time()));
        $DB->insert_record('role_capabilities', array('contextid'=>$forumdata->id, 'capability'=> "mod/forum:deleteownpost", "roleid"=>5, "permission"=>-1000, "timemodified"=>time()));
        $DB->insert_record('role_capabilities', array('contextid'=>$forumdata->id, 'capability'=> "mod/forum:exportownpost", "roleid"=>5, "permission"=>-1000, "timemodified"=>time()));
    }catch(\Exception $e){}
    ...
    $DB->update_record('local_problemsection_status', array('id'=>$getmodulestatusid->id, 'forumrefuteid'=>$forum->id));
