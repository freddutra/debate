...
try{
    ...
    // ugly hack
    // mod/forum:replypost =  -1
    try{$DB->insert_record('role_capabilities', array('contextid'=>$forum->id, 'roleid'=>5, 'capability'=> 'mod/forum:replypost', 'timemodified'=>time(), 'permission'=>"-1"));}catch(\Exception $e){}
    // forum:deleteownpost =  -1
    try{$DB->insert_record('role_capabilities', array('contextid'=>$forum->id, 'roleid'=>5, 'capability'=> 'mod/forum:deleteownpost', 'timemodified'=>time(), 'permission'=>"-1"));}catch(\Exception $e){}
    // forum:exportownpost =  -1
    try{$DB->insert_record('role_capabilities', array('contextid'=>$forum->id, 'roleid'=>5, 'capability'=> 'mod/forum:exportownpost', 'timemodified'=>time(), 'permission'=>"-1"));}catch(\Exception $e){}
